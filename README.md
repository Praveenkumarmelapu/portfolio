...
A modern, responsive, and glassmorphic personal portfolio website designed to showcase web development projects, skills, and technical experience. It features a custom, self-contained **AI Portfolio Assistant** widget to provide visitors with an interactive, conversational exploration of the portfolio.
...
- **Interactive AI Assistant:** A built-in virtual assistant that visitors can chat with to explore projects, skills, education, and contact details.
...
- **Interactive Actions:** Triggers smooth scrolling to sections (like `#projects`, `#contact`), opens WhatsApp/Email links, or opens preview modals directly from the chat.
...
- `index.html` - The main portfolio web page.
...
- `knowledge.json` - Structured JSON file containing all portfolio information.
